...
class Transaction(models.Model):
    transaction_type = models.ForeignKey(TransactionType,
                                         related_name='type',on_delete=models.CASCADE, null=True)
    command_id = models.ForeignKey(MpesaCommandId,
                                   related_name='command_id',on_delete=models.CASCADE, null=True)
    identifier_type = models.ForeignKey(IdentifierType,
                                        related_name='identifier_type',on_delete=models.CASCADE, null=True)
    amount = models.DecimalField(null=True, decimal_places=2, max_digits=6)
    party_b = models.ForeignKey(CompanyShortCodeOrNumber,
                                related_name='party_b',on_delete=models.CASCADE, null=True)
    initiator_name = models.ForeignKey(InitiatorName,
                                       related_name='company_name',on_delete=models.CASCADE, null=True)
    party_a = models.ForeignKey(CompanyShortCodeOrNumber,on_delete=models.CASCADE,
                                related_name='party_a')
    occasion = models.ForeignKey(Occassion,on_delete=models.CASCADE,
                                 related_name='shortcode')
    account_reference = models.ForeignKey(MpesaCommandId,
                                          related_name='account_reference', on_delete=models.CASCADE,null=True)
...
class TransactionResponse(models.Model):
    ...
    transaction = models.ForeignKey(Transaction,
                                    related_name='response',on_delete=models.CASCADE, null=True)
...
class Registration(models.Model):
    company_code = models.ForeignKey(
        CompanyShortCodeOrNumber, related_name='CompanyShortCodeOrNumber',on_delete=models.CASCADE,
        null=True)
    company_name = models.ForeignKey(InitiatorName,
                                     related_name='registration',on_delete=models.CASCADE, null=True)
